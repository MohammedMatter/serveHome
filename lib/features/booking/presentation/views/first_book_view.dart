          ...
          (context, provBooking, child) => Scaffold(
            bottomNavigationBar: BottomNavigationBarDetailsWidget(
              ...
              navigationToAnotherScreen: () {
                if (provBooking.selectedDate.isEmpty ||
                    provBooking.selectedTime.isEmpty) {
                  showDialog(
                        ...
                        (context) => AlertDialog(
                          title: Text(
                            ...
                            style: AppStyle.body17(context).copyWith(
                              fontSize: (ScreenSize.w(context) * 0.045).clamp(
                                16,
                                20,
                              ),
                            ),
                            ...
                            TextButton(
                              ...
                              child: Text(
                                ...
                                style: AppStyle.body16(context).copyWith(
                                  fontSize: (ScreenSize.w(context) * 0.04)
                                      .clamp(14, 18),
                                ),
                              ),
                            ),
                ...
                GoRouter.of(
                  context,
                ).pushNamed(AppRouter.secondBookView, extra: service);
              },
            ),
            body: SafeArea(
              child: Padding(
